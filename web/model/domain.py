...
def analysis_request(request):
    ...
    table5 = []
    table5.append(protocol_list(all_list, "all"))
    table5.append(protocol_list(tcpv4_list, "tcpv4"))
    table5.append(protocol_list(tcpv6_list, "tcpv6"))
    table5.append(protocol_list(udpv4_list, "udpv4"))
    table5.append(protocol_list(udpv6_list, "udpv6"))
    table5.append(protocol_list(otherv4_list, "otherv4"))
    table5.append(protocol_list(otherv6_list, "otherv6"))
    result.append(table5)

    table6 = []
    table6.append(protocol_list(ipv4_list, "ipv4"))
    table6.append(protocol_list(ipv6_list, "ipv6"))
    table6.append(protocol_list(icmpv4_list, "icmpv4"))
    table6.append(protocol_list(icmpv6_list, "icmpv6"))
    table6.append(protocol_list(uniCast_list, "uniCast"))
    table6.append(protocol_list(broadCast_list, "broadCast"))
    table6.append(protocol_list(multcast_list, "multicast"))
    result.append(table6)

    table7 = []
    table7.append(protocol_list(arp_list, "arp"))
    table7.append(protocol_list(rarp_list, "rarp"))
    table7.append(protocol_list(other_list, "other"))
    table7.append(protocol_list(outFlow_list, "outFlow"))
    table7.append(protocol_list(inputFlow_list, "inputFlow"))
    result.append(table7)

    table8 = port_list()
    result.append(table8)
